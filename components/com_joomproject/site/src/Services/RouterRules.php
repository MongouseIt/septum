...
namespace Joomla\Component\Joomproject\Site\Service;
...
class RouterRules implements RulesInterface
{
    ...
    {
        $segments = self::JoomprojectBuildRoute($query);
    ...
    {
        $vars = self::JoomprojectParseRoute($segments);
    ...
    /**
     * Build the route for the com_joomproject component
     *
     * @param     array    $query    An array of URL arguments
     *
     * @return    array              The URL arguments to use to assemble the subsequent URL.
     */
    public static function JoomprojectBuildRoute(&$query)
    {
        ...
        if ($view == 'dashboard') {
            ...
            if (isset($query['id'])) {
                if (strpos($query['id'], ':') === false) {
                    $query['id'] = self::JoomprojectMakeSlug($query['id'], '#__jp_projects');
                }
            }
            else {
                $query['id'] = self::JoomprojectMakeSlug('0', '#__jp_projects');
            }
     ...
     */
    public static function JoomprojectParseRoute($segments)
    {
        ...
        if ($vars['view'] == 'dashboard') {
            if ($count == 1) {
                $vars['id'] = self::JoomprojectParseSlug($segments[0]);
            }
     ...
     */
    public static function JoomprojectParseSlug($segment)
    {
     ...
     */
    public static function JoomprojectMakeSlug($id, $table, $alt = 'all', $field = 'alias')
    {
        if ($id == '' || $id == '0') {
