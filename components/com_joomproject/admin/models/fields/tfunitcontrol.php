...
class JFormFieldTFUnitControl extends TextField
{
    ...
    public function getInput()
    {
        ...
        $parsedValue = Control::findUnitInValue($this->value);
    ...
    {
        HTMLHelper::script('com_joomproject/autosize-input.js', ['relative' => true, 'version' => 'auto']);
        HTMLHelper::stylesheet('com_joomproject/unit.css', ['relative' => true, 'version' => 'auto']);
    }
}