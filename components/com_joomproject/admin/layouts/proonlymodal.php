...
HTMLHelper::stylesheet('com_joomproject/proonlymodal.css', ['relative' => true, 'version' => 'auto']);
?>
<div class="pro-only-body text-center">
    ...
    <div class="po-feature">
        <h2><?php echo Text::sprintf('COM_JOOMPROJECT_GALLERY_PROFEATURE_HEADER', '') ?></h2>
        <p><?php echo Text::sprintf('COM_JOOMPROJECT_GALLERY_PROFEATURE_DESC', '') ?></p>
    </div>

    <!-- This is shown when click on Upgrade to Pro button -->
    <div class="po-upgrade">
        <h2><?php echo Text::_($extension_name) ?> Pro</h2>
        <p><?php echo Text::sprintf('COM_JOOMPROJECT_GALLERY_UPGRADE_TO_PRO_VERSION', Text::_($extension_name)); ?></p>
    </div>
    ...
    <p><a class="btn btn-danger btn-large" href="<?php echo $upgrade_url ?>" target="_blank">
        ...
        <?php echo Text::_('COM_JOOMPROJECT_GALLERY_UPGRADE_TO_PRO') ?>
    </a></p>
    <div class="pro-only-bonus">
        <div class="po-checkmark-icon"></div>
        <?php echo Text::sprintf('COM_JOOMPROJECT_GALLERY_PROFEATURE_DISCOUNT', $extension_name) ?>
    </div>

    <div class="pro-only-footer">
        <div><?php echo Text::_('COM_JOOMPROJECT_GALLERY_UPDATE_PRE_SALES_QUESTIONS'); ?> <a target="_blank" href="http://www.tassos.gr/contact?topic=Pre-sale Question&extension=<?php echo $extension_name ?>"><?php echo Text::_('COM_JOOMPROJECT_GALLERY_ASK_HERE'); ?></a></div>
        <div><?php echo Text::_('COM_JOOMPROJECT_GALLERY_ALREADY_PURCHASED_PRO_LEARN_HOW_TO'); ?> <a target="_blank" href="https://www.tassos.gr/kb/general/how-to-upgrade-an-extension-from-free-to-pro"><?php echo Text::_('COM_JOOMPROJECT_GALLERY_UNLOCK_PRO_FEATURES'); ?></a></div>
    </div>
</div>