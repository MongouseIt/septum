 ...
 *
 */
class JPdesignsModelDesignForm extends JPdesignsModelDesign
{
    /**
    ...
    public function getItem($id = null)
    {
        ...
        $value->labels = $labels->getConnections('com_jpdesigns.design', $value->id);

        // Compute selected asset permissions.
        $uid = Factory::getApplication()->getIdentity()->get('id');

        if ($id) {
            $access = JPdesignsHelper::getActions($value->id);
        }
        else {
