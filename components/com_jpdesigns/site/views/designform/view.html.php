...
/**
 * Design Form View Class for Joomproject Designs component
 *
 */
class JPdesignsViewDesignForm extends HtmlView
{
    protected $form;
    protected $item;
    ...
    protected function _prepareDocument()
    {
        ...
        $def_title = Text::_('COM_JOOMPROJECT_PAGE_' . ($this->item->id > 0 ? 'EDIT' : 'ADD') . '_DESIGN');
    ...
    protected function getToolbar()
    {
        ...
        $options[] = array(
            'text' => 'COM_JOOMPROJECT_ACTION_2DESIGNREVISION',
            'task' => $this->getName() . '.save2rev');
