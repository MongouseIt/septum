...
<div class="card card-body mb-4">
    <div class="input-group">
            <input type="text" name="filter_search" class="form-control" placeholder="<?php echo Text::_('JSEARCH_FILTER_SEARCH'); ?>" id="filter_search" value="<?php echo $this->escape($this->state->get('filter.search')); ?>"/>
    ...
    <div class="filters btn-toolbar row mt-3">
        <?php if ($this->state->get('filter.project')) : ?>
        <div class="col-md-3">
            <select id="filter_author" name="filter_author" class="form-select" onchange="this.form.submit()">
        ...
        <?php endif; ?>
        <div class="filter-order col-md-3">
        ...
        <div class="folder-order-dir col-md-3">
