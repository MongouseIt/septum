...
class JPdesignsViewDesigns extends HtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->access     = JPdesignsHelper::getActions();
    ...
    protected function prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', Text::_('COM_JOOMPROJECT_DESIGNS'));
        }
    ...
    protected function getSortOptions()
    {
        ...
        $options[] = HTMLHelper::_('select.option', 'a.ordering', Text::_('COM_JOOMPROJECT_ORDER_ORDERING'));
        $options[] = HTMLHelper::_('select.option', 'a.title', Text::_('COM_JOOMPROJECT_ORDER_TITLE'));
        $options[] = HTMLHelper::_('select.option', 'album_title', Text::_('COM_JOOMPROJECT_ORDER_DESIGN_ALBUM'));
