...
/**
 * Album Form View Class for Joomproject Designs component
 *
 */
class JPdesignsViewAlbumForm extends HtmlView
{
    protected $form;
    protected $item;
    ...
    protected function _prepareDocument()
    {
        ...
        $def_title = Text::_('COM_JOOMPROJECT_PAGE_' . ($this->item->id > 0 ? 'EDIT' : 'ADD') . '_ALBUM');

        // Because the application sets a default page title, we need to get it from the menu item itself
        if ($menu) {
            if (strpos($menu->link, 'view=albums') !== false) {
