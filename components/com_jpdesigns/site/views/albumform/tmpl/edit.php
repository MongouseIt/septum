...
<div id="joomproject" class="edit item-page<?php echo $this->pageclass_sfx; ?>">
    ...
    <form action="<?php echo Route::_('index.php?option=com_jpdesigns&view=albumform&id=' . (int) $this->item->id . '&layout=edit'); ?>"
        ...
        if (count($fieldsets)) : ?>
            ...
            <?php echo HTMLHelper::_('uitab.endTab'); ?>
        <?php endif; ?>
        <?php if ($user->authorise('core.admin', 'com_jpdesigns') || $user->authorise('core.manage', 'com_jprepo')) : ?>
