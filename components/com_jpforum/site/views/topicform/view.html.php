...
/**
 * Topic Form View Class for Joomproject component
 *
 */
class JPforumViewTopicForm extends HtmlView
{
    protected $form;
    protected $item;
    ...
    protected function _prepareDocument()
    {
        ...
        $def_title = Text::_('COM_JOOMPROJECT_PAGE_' . ($this->item->id > 0 ? 'EDIT' : 'ADD') . '_TOPIC');
