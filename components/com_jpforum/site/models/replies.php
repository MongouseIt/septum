 ...
 *
 */
class JPforumModelReplies extends ListModel
{
    ...
    public function getListQuery()
    {
        ...
        $query->join('LEFT', '#__jp_topics AS t ON t.id = a.topic_id');
        ...
        $query->join('LEFT', '#__jp_ref_attachments AS at ON (at.item_type = '
              . $db->quote('com_jpforum.reply') . ' AND at.item_id = a.id)');
    ...
    public function getTopic()
    {
        ...
        $model = $this->getInstance('TopicForm', 'JPforumModel', array('ignore_request' => true));
    ...
    public function getAuthors()
    {
        ...
        $query->join('INNER', '#__jp_replies AS a ON a.created_by = u.id');
    ...
    protected function populateState($ordering = 'a.created', $direction = 'ASC')
    {
        ...
        // Filter - Topic
        $topic = \Joomla\CMS\Factory::getApplication()->input->getCmd('filter_topic', '');
