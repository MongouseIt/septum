...
// Access check
if (!Factory::getApplication()->getIdentity()->authorise('core.manage', 'com_jpforum')) {
...
JLoader::register('JPforumHelper', JPATH_ADMINISTRATOR . '/components/com_jpforum/helpers/jpforum.php');
HTMLHelper::addincludepath(JPATH_ADMINISTRATOR . '/components/com_jpforum/helpers/html');
...
$controller = BaseController::getInstance('JPforum');
