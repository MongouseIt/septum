...
JLoader::register('JPtableReplyCompat', dirname(__FILE__) . '/reply_compat.php');
 ...
 *
 */
class JPtableReply extends JPtableReplyCompat
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__jp_replies', 'id', $db);
    ...
    {
        $k = $this->_tbl_key;
        return 'com_jpforum.reply.' . (int) $this->$k;
    }
    ...
    public function check()
    {
        ...
        if ((int) $this->topic_id <= 0) {
            $this->setError(Text::_('COM_JOOMPROJECT_WARNING_SELECT_TOPIC'));
            return false;
        }
    ...
    public function deleteReferences($pk = null)
    {
        ...
        $query->delete('#__jp_ref_attachments')
              ...
              ->where('item_type = ' . $this->_db->quote('com_jpforum.reply'));
