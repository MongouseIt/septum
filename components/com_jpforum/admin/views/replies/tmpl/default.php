...
<form action="<?php echo Route::_('index.php?option=com_jpforum&view=replies&filter_topic=' . $filter_topic); ?>"
            ...
            <table class="adminlist table table-striped">
                ...
                <?php foreach ($this->items as $i => $item) :
                    ...
                    <tr class="row<?php echo $i % 2; ?>">
                        ...
                        <td class="center">
                            <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'replies.', $can_change, 'cb'); ?>
                        </td>
                        <td class="has-context">
                            <div class="float-start">
                                <?php if ($item->checked_out) : ?>
                                    <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'replies.', $can_checkin); ?>
                                <?php endif; ?>

                                <?php if ($can_edit || $can_edit_own) : ?>
                                    <a href="<?php echo Route::_('index.php?option=com_jpforum&task=reply.edit&id=' . $item->id); ?>">
                                        <?php echo $this->escape(HTMLHelper::_('jp.html.truncate', $item->description, 80)); ?>
                                    </a>
                                <?php else : ?>
                                    <?php echo $this->escape(HTMLHelper::_('jp.html.truncate', $item->description, 80)); ?>
                                <?php endif; ?>
                        ...
                        <td class="center d-none d-md-table-cell small">
