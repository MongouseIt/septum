...
<form action="<?php echo Route::_('index.php?option=com_jpforum&view=topics'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        ...
        <thead>
            <tr>
                ...
                <th width="5%" class="center nowrap">
                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_JOOMPROJECT_REPLIES', 'replies', $list_dir, $list_order); ?>
                </th>
        ...
        <?php foreach ($this->items as $i => $item) :
            ...
            <tr class="row<?php echo $i % 2; ?>">
                ...
                <td class="center">
                    <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'topics.', $can_change, 'cb'); ?>
                </td>
                <td class="has-context">
                    <div class="float-start">
                        <?php if ($item->checked_out) : ?>
                            <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'topics.', $can_checkin); ?>
                        <?php endif; ?>

                        <?php if ($can_edit || $can_edit_own) : ?>
                            <a href="<?php echo Route::_('index.php?option=com_jpforum&task=topic.edit&id=' . $item->id);?>">
                ...
                <td class="center">
                    <a href="<?php echo Route::_('index.php?option=com_jpforum&view=replies&filter_topic=' . $item->id);?>">
