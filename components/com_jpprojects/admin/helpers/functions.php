...
class JoomprojectFunctions
{
	...
	public static function getExtensionVersion($extension, $type = false)
	{
		...
		$cache = JoomprojectCache::read($hash);
		...
		return JoomprojectCache::set($hash, $version);
	}
	...
	public static function params()
	{
		...
		if (JoomprojectCache::has($hash))
		{
			return JoomprojectCache::read($hash);
		}
		...
		return JoomprojectCache::set($hash, new Registry($result));
	}
