...
class JoomprojectWebClient
{
	...
	{
		$detect = new Joomla\CMS\Object\CMSObject();//MobileDetect(null, $ua);
		return  null;//($detect->isMobile() ? ($detect->isTablet() ? 'tablet' : 'mobile') : 'desktop');
	}
