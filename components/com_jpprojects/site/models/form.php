...
JLoader::register('JPprojectsModelProject', JPATH_ADMINISTRATOR . '/components/com_jpprojects/models/project.php');
 ...
 *
 */
class JPprojectsModelForm extends JPprojectsModelProject
{
    /**
