...
<div id="joomproject" class="edit item-page<?php echo $this->pageclass_sfx; ?>">
    ...
    <form action="<?php echo Route::_('index.php?option=com_jpmilestones&view=form&id=' . (int) $this->item->id . '&layout=edit'); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
        <div class="mb-4">
        ...
        <?php echo HTMLHelper::_('uitab.endTab'); ?>
            <?php if (JPApplicationHelper::enabled('com_jprepo')) : ?>
                <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'attachments', '<i class="fas fa-paperclip"></i> '.Text::_('COM_JOOMPROJECT_FIELDSET_ATTACHMENTS')); ?>
                    <fieldset>
                        <div class="formelm form-group"  id="jform_attachment_element">
            ...
            <?php endif; ?>
               ...
               if (count($fieldsets)) : ?>
          <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'options', '<i class="fas fa-flag"></i> '.Text::_('COM_JOOMPROJECT_FIELDSET_DETAILS')); ?>
                ...
                <?php if ($user->authorise('core.admin', 'com_jpmilestones') || $user->authorise('core.manage', 'com_jpmilestones')) : ?>
