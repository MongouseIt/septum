    ...
    <table class="table table-striped cat-items">
        <thead>
            <tr>
                ...
                <th class="nowrap center" style="width: 8%"><?php echo Text::_('COM_JOOMPROJECT_TASKS'); ?></th>
                <th class="nowrap" style="width: 8%"><?php echo Text::_('COM_JOOMPROJECT_FIELD_START_DATE_LABEL'); ?></th>
