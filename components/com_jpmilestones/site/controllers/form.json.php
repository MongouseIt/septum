...
JLoader::register('JPmilestonesControllerMilestone', JPATH_ADMINISTRATOR . '/components/com_jpmilestones/controllers/milestone.json.php');
 ...
 *
 */
class JPmilestonesControllerForm extends JPmilestonesControllerMilestone
{
    /**
