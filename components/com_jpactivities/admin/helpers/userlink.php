 ...
 *
 */
class JPactivitiesHelperUserLink
{
    /**
    ...
    public static function get($id, $name = null, $dest = null)
    {
        switch ($dest)
        {
            ...
            case 'joomproject':
                return self::joomproject($id, $name);
                break;
    ...
    /**
     * Method to link to a Joomproject user profile page
     *
     * @param     integer    $id      The user id
     * @param     string     $name    The user name
     *
     * @return    string              The profile url
     */
    protected static function joomproject($id, $name = null)
    {
        static $router = null;

        // Include the route helper once
        if (is_null($router)) {
            $file = JPATH_SITE . '/components/com_jpusers/helpers/route.php';
        ...
        // Return link
        return JPusersHelperRoute::getUserRoute($slug);
    }
}
