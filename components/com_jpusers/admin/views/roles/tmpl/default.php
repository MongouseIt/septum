...
if ($saveOrder)
{
    $saveOrderingUrl = 'index.php?option=com_joomproject&task=roles.saveOrderAjax&tmpl=component';
    HTMLHelper::_('sortablelist.sortable', 'timetypeList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}

?>

<form action="<?php echo Route::_('index.php?option=com_jpusers&view=roles');?>"
      method="post"
      name="adminForm"
      id="adminForm"
>
    ...
    <div class="row">
        ...
        <table class=" adminlist table table-striped" id="roleList">
            <thead>
            <tr>
            ...
            <?php foreach ($this->items as $i => $item) :
                ...
                $canChange = $user->authorise('core.manage.roles', 'com_jpprojects');
                $link = Route::_('index.php?option=com_jpusers&view=role&layout=edit&id=' . $item->id);
