...
class JPusersViewTeam extends HtmlView{
    ...
    protected function addToolbar(){
        ...
        ToolbarHelper::title(Text::_('COM_JOOMPROJECT_TEAMS').' - '.Text::_('COM_JOOMPROJECT_'.($this->isNew ? 'NEW' : 'EDIT').'_'.strtoupper($this->view)),'plus');

        if( $this->isNew ){

            if( $this->canDo->get('core.manage.teams') ){
