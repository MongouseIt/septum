 ...
 *
 */
class JPusersModelUserRef extends ListModel
{
    /**
     * Constructor
     *
    ...
    protected function getListQuery()
    {
        ...
        $filter_groups = JPAccessHelper::getGroupsByAccessLevel($filter_access, true);
    ...
    protected function populateState($ordering = 'a.username', $direction = 'asc')
    {
        ...
        // Filter - Search
        $search = \Joomla\CMS\Factory::getApplication()->input->getCmd('filter_search');
        $this->setState('filter.search', $search);

        // Filter - Access
        $access = \Joomla\CMS\Factory::getApplication()->input->getUInt('filter_access');
