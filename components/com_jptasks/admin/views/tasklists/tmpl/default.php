...
<form action="<?php echo Route::_('index.php?option=com_jptasks&view=tasklists'); ?>" method="post" name="adminForm" id="adminForm">
<div class="row">
    ...
    <div id="j-main-container" class="col-md-10">
        ...
        <table class="adminlist table table-striped">
            ...
            <tr>
                ...
                <th width="5%" class="center">
                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_JOOMPROJECT_TASKS_TITLE', 'task_count', $list_dir, $list_order); ?>
                </th>
            ...
            <?php foreach ($this->items as $i => $item) :
                $access = JPtasksHelper::getListActions($item->id);
                ...
                <tr class="row<?php echo $i % 2; ?>">
                    ...
                    <td class="center">
                        <?php echo HTMLHelper::_('jgrid.published', $item->state, $i, 'tasklists.', $can_change, 'cb'); ?>
                    </td>
                    <td class="has-context">
                        <div class="float-start">
                            <?php if ($item->checked_out) : ?>
                                <?php echo HTMLHelper::_('jgrid.checkedout', $i, $item->editor, $item->checked_out_time, 'tasklists.', $can_checkin); ?>
                            <?php endif; ?>

                            <?php if ($can_edit || $can_edit_own) : ?>
                                <a href="<?php echo Route::_('index.php?option=com_jptasks&task=tasklist.edit&id=' . $item->id);?>">
