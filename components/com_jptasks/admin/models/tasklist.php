 ...
 *
 */
class JPtasksModelTasklist extends AdminModel
{
    /**
     ...
     */
    public function getTable($type = 'Tasklist', $prefix = 'JPtable', $config = array())
    {
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_jptasks.tasklist', 'tasklist', array('control' => 'jform', 'load_data' => $loadData));
        ...
        if ($id != 0 && (!$user->authorise('core.edit.state', 'com_jptasks.tasklist.' . $id)) || ($id == 0 && !$user->authorise('core.edit.state', 'com_jptasks')))
        {
    ...
    protected function canDelete($record)
    {
        ...
        return $user->authorise('core.delete', 'com_jptasks.tasklist.' . (int) $record->id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        return $user->authorise('core.edit.state', 'com_jptasks.tasklist.' . (int) $record->id);
    }
    ...
    protected function canEdit($record)
    {
        ...
        $user  = Factory::getApplication()->getIdentity();
        $asset = 'com_jptasks.tasklist.' . (int) $record->id;
