...
JLoader::register('JPtableTasklistCompat', dirname(__FILE__) . '/tasklist_compat.php');
 ...
 *
 */
class JPtableTasklist extends JPtableTasklistCompat
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__jp_task_lists', 'id', $db);
    ...
    {
        $k = $this->_tbl_key;
        return 'com_jptasks.tasklist.' . (int) $this->$k;
    }
    ...
    public function bind($array, $ignore = '')
    {
        ...
        if(is_null($array['milestone_id']) || empty($array['milestone_id'])){
    ...
    public function store($updateNulls = false)
    {
        ...
        if ($table->load($data) && ($table->id != $this->id || $this->id==0)) {
            $this->setError(Text::_('JLIB_DATABASE_ERROR_TASKLIST_UNIQUE_ALIAS'));
            return false;
        }
