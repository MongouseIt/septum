...
require_once JPATH_ADMINISTRATOR . '/components/com_jptasks/controllers/tasklist.json.php';


/**
 * Joomproject Task List Form Controller
 *
 */
class JPtasksControllerTasklistForm extends JPtasksControllerTasklist
{
    /**
