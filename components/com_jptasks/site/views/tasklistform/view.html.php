 ...
 *
 */
class JPtasksViewTasklistForm extends HtmlView
{
    protected $form;
    protected $item;
    ...
    public function display($tpl = null)
    {
        ...
        // Permission check.
        if ($this->item->id <= 0) {
            $access = JPtasksHelper::getListActions();
    ...
    protected function _prepareDocument()
    {
        ...
        $def_title = Text::_('COM_JOOMPROJECT_PAGE_' . ($this->item->id > 0 ? 'EDIT' : 'ADD') . '_TASKLIST');
