...
<div id="joomproject" class="edit item-page<?php echo $this->pageclass_sfx; ?>">
    ...
    <form action="<?php echo Route::_('index.php?option=com_jptasks&view=tasklistform&id=' . (int) $this->item->id . '&layout=edit'); ?>"
        ...
        <?php echo HTMLHelper::_('uitab.addTab', 'myTab', 'general', Text::_('COM_JOOMPROJECT_FIELDSET_TASKS')); ?>
        <fieldset>
