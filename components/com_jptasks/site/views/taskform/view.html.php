...
/**
 * Task Form View Class for Joomproject component
 *
 */
class JPtasksViewTaskForm extends HtmlView
{
    protected $form;
    protected $item;
    ...
    protected function _prepareDocument()
    {
        ...
        $def_title = Text::_('COM_JOOMPROJECT_PAGE_' . ($this->item->id > 0 ? 'EDIT' : 'ADD') . '_TASK');
    ...
    protected function getToolbar()
    {
        ...
        JPToolbar::dropdownButton($options, array('icon' => 'fas fa-check'));

        JPToolbar::button(
            'JCANCEL',
            $this->getName() . '.cancel',
            false,
            array('class' => 'btn btn-danger', 'icon' => 'fas fa-times')
        );
