 ...
 * @static
 */
abstract class JPtasksHelperRoute
{
    /**
    ...
    {
        $link  = 'index.php?option=com_jptasks&view=tasks';
    ...
    {
        $link  = 'index.php?option=com_jptasks&view=task';
        $link .= '&filter_project=' . $project;
        $link .= '&filter_milestone=' . $milestone;
        $link .= '&filter_tasklist=' . $list;
        $link .= '&id=' . $id;
        ...
        if ($item = JPApplicationHelper::itemRoute($needles, 'com_jptasks.task')) {
            $link .= '&Itemid=' . $item;
        }
        elseif ($item = JPApplicationHelper::itemRoute(null, 'com_jptasks.tasks')) {
            $link .= '&Itemid=' . $item;
        }
