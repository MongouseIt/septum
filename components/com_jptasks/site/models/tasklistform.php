...
JLoader::register('JPtasksModelTasklist', JPATH_ADMINISTRATOR . '/components/com_jptasks/models/tasklist.php');


/**
 * Joomproject Component Task List Form Model
 *
 */
class JPtasksModelTasklistForm extends JPtasksModelTasklist
{
    /**
