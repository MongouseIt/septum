 ...
 *
 */
class JPrepoModelAttachment extends AdminModel
{
    /**
     ...
     * @var    string
     */
    protected $text_prefix = 'COM_JOOMPROJECT_ATTACHMENT';
     ...
     */
    public function getTable($type = 'Attachment', $prefix = 'JPtable', $config = array())
    {
     ...
     *
     */
    protected function cleanCache($group = 'com_jprepo', $client = 0)
    {
    ...
    protected function canDelete($record)
    {
        ...
        $delete_repo = JoomprojectHelperAccess::getActions($asset, $id);
