 ...
 *
 */
class JPrepoModelNoteRevision extends AdminModel
{
    /**
    ...
    protected function canDelete($record)
    {
        ...
        return Factory::getApplication()->getIdentity()->authorise('core.delete', 'com_jprepo.note.' . (int) $record->parent_id);
    }
    ...
    protected function canEditState($record)
    {
        ...
        return Factory::getApplication()->getIdentity()->authorise('core.edit.state', 'com_jprepo.note.' . (int) $record->parent_id);
    }
    ...
    protected function canEdit($record)
    {
        ...
        $asset = 'com_jprepo.note.' . (int) $record->parent_id;
