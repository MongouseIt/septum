 ...
 *
 */
class JPrepoModelFileRevisions extends ListModel
{
    /**
     * Constructor
     *
    ...
    public function getItem($pk = 0)
    {
        ...
        $model = $this->getInstance('File', 'JPrepoModel', $cfg);
    ...
    public function getAuthors()
    {
        ...
        $query->select('u.id AS value, u.name AS text')
              ->from('#__users AS u')
              ->join('INNER', '#__jp_repo_file_revs AS a ON a.created_by = u.id')
    ...
    protected function getListQuery()
    {
        ...
        $query->from('#__jp_repo_file_revs AS a');
