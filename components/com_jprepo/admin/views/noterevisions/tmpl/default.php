...
<form action="<?php echo Route::_('index.php?option=com_jprepo&view=noterevisions'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
    ...
    <table class="adminlist table table-striped">
        ...
        <tbody>
            <?php foreach ($this->items as $i => $item) :
                ...
                $dl_link = 'index.php?option=com_jprepo&task=note.edit'
