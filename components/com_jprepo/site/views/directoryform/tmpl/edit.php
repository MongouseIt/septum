...
{
    if (task == 'directoryform.cancel' || document.formvalidator.isValid(document.getElementById('item-form'))) {
...
<div id="joomproject" class="edit item-page<?php echo $this->pageclass_sfx; ?>">
    ...
    <form action="<?php echo Route::_('index.php?option=com_jprepo&view=directoryform&id=' . (int) $this->item->id . '&layout=edit'); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
