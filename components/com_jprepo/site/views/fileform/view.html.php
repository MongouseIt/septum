...
/**
 * File Form View Class for Joomproject component
 *
 */
class JPrepoViewFileForm extends HtmlView
{
    protected $form;
    protected $item;
    ...
    public function display($tpl = null)
    {
        ...
        if (empty($this->item->id)) {
            $access = JPrepoHelper::getActions('file');
    ...
    protected function _prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', Text::_('COM_JOOMPROJECT_FORM_EDIT_FILE'));
        }

        $title = $this->params->def('page_title', Text::_('COM_JOOMPROJECT_FORM_EDIT_FILE'));
