 ...
 *
 */
class JPrepoModelFileRevision extends JPrepoModelFileForm
{
    /**
    ...
    protected function canEditState($record)
    {
		...
		if (!empty($record->parent_id)) {
			return $user->authorise('core.edit.state', 'com_jprepo.file.' . (int) $record->parent_id);
		}
		else {
