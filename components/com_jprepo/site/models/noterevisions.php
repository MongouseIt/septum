...
/**
 * Methods supporting a list of note revisions.
 *
 */
class JPrepoModelNoteRevisions extends ListModel
{
    /**
     * Constructor
     *
    ...
    /**
     * Method to load the note head revision
     *
    ...
    public function getItem($pk = 0)
    {
        ...
        $model = $this->getInstance('Note', 'JPrepoModel', $cfg);
    ...
    public function getAuthors()
    {
        ...
        $query->select('u.id AS value, u.name AS text')
              ->from('#__users AS u')
              ->join('INNER', '#__jp_repo_note_revs AS a ON a.created_by = u.id')
    ...
    protected function getListQuery()
    {
        ...
        $query->select(
            $this->getState(
                ...
                . 'a.created, a.created_by, a.attribs, a.ordering'
            )
        );

        $query->from('#__jp_repo_note_revs AS a');
