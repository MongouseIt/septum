...
/**
 * Joomproject Component File Model
 *
 */
class JPrepoModelFile extends ItemModel
{
    /**
     ...
     * @var    string
     */
    protected $_context = 'com_jprepo.file';
    ...
    public function &getItem($pk = null)
    {
        ...
        try {
            ...
            if (empty($item)) {
                return Factory::getApplication()->enqueueMessage( Text::_('COM_JOOMPROJECT_ERROR_FILE_NOT_FOUND'),'error');
            }
            ...
            $item->physical_path = JPrepoHelper::getFilePath($item->file_name, $item->dir_id);
