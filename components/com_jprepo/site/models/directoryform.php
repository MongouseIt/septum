...
require_once JPATH_ADMINISTRATOR . '/components/com_jprepo/models/directory.php';
 ...
 *
 */
class JPrepoModelDirectoryForm extends JPrepoModelDirectory
{
    /**
    ...
    protected function populateState()
    {
        ...
        $pk      = \Joomla\CMS\Factory::getApplication()->input->getUInt('id');
