...
/**
 * Joomproject Time Form Controller
 *
 */
class JPtimeControllerForm extends FormController
{
    /**
     ...
     */
    public function &getModel($name = 'Form', $prefix = 'JPtimeModel', $config = array('ignore_request' => true))
    {
    ...
    protected function getReturnPage()
    {
        ...
        if (empty($return) || !Uri::isInternal(base64_decode($return))) {
            return Route::_('index.php?option=com_jptime&view=' . $this->view_list, false);
        }
        else {
