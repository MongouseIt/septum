...
JLoader::register('JPtimeControllerTime', JPATH_ADMINISTRATOR . '/components/com_jptime/controllers/time.json.php');
 ...
 *
 */
class JPtimeControllerForm extends JPtimeControllerTime
{
    /**
