...
class JPtimeViewTimesheet extends HtmlView
{
    ...
    public function display($tpl = null)
    {
        ...
        $this->access     = JPtimeHelper::getActions();
    ...
    protected function prepareDocument()
    {
        ...
        if ($menu) {
            ...
            $this->params->def('page_heading', Text::_('COM_JOOMPROJECT_TIMESHEET_TITLE'));
        }
    ...
    protected function getToolbar()
    {
        ...
        if ($access->get('core.create')) {
            $options   = array();
            $options[] = array('text' => 'COM_JOOMPROJECT_ACTION_NEW', 'task' => 'form.add');
            $options[] = array('text' => 'COM_JOOMPROJECT_TIME_RECORDER_OPEN', 'task' => 'recorder');
            JPToolbar::dropdownButton($options);
        }
    ...
    protected function getSortOptions()
    {
        ...
        $options[] = HTMLHelper::_('select.option', 'a.log_date', Text::_('COM_JOOMPROJECT_ORDER_LOG_DATE'));
        $options[] = HTMLHelper::_('select.option', 'a.created', Text::_('COM_JOOMPROJECT_ORDER_CREATE_DATE'));
        $options[] = HTMLHelper::_('select.option', 'task_title', Text::_('COM_JOOMPROJECT_ORDER_TASK'));
