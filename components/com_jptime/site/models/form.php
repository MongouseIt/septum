...
JLoader::register('JPtimeModelTime', JPATH_ADMINISTRATOR . '/components/com_jptime/models/time.php');


/**
 * Joomproject Time Form Model
 *
 */
class JPtimeModelForm extends JPtimeModelTime
{
    /**
