...
if (version_compare(JVERSION, '3.0.0', '>=')) {
    class JPJFormRuleCompat extends FormRule
    {
 ...
 *
 */
class JFormRuleGroupAccess extends JPJFormRuleCompat
{
    /**
    ...
    protected function getFieldActions($element)
    {
        ...
        $component = $element['component'] ? (string) $element['component'] : 'com_joomproject';

        // Get the asset actions for the element.
        $elActions = JPAccessHelper::getActions($component, $section);
