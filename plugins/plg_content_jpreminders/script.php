...
class plgContentJpremindersInstallerScript
{
    ...
    public function postflight($route, $parent)
    {
        ...
        if ($action == 'install' || $action == 'update') {
            ...
            $cli_j3_source = JPATH_SITE . '/plugins/content/jpreminders/cli/jpreminders.php';
            $cli_j3_dest   = JPATH_SITE . '/cli/jpreminders.php';


            if (file_exists($cli_j3_source)) {
                if (file_exists($cli_j3_dest)) {
                    if (\Joomla\CMS\Filesystem\File::delete($cli_j3_dest)) {
