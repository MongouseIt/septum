...
class plgJPactivitiesJPtime extends plgJPactivities
{
    /**
    ...
    public function onJPactivitiesAfterSave($context, $table, $is_new, $store = true)
    {
        ...
        if (\Joomla\CMS\Factory::getApplication()->input->get('task') == 'add') return true;
    ...
    /**
     * Method to get a partial time record
     *
     * @param     integer    $id    The time record id
     *
     * @return    object            The time record data
     */
    private function getItem($id)
    {
        ...
        $query->select('a.asset_id, a.project_id, a.task_id, a.task_title AS title, a.access, a.log_time')
