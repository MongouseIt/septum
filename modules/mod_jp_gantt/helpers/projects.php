 ...
 *
 */
abstract class modJPganttHelperProjects
{
    /**
    ...
    public static function getItems()
    {
        ...
        $params = modJPganttHelper::$params;
        ...
        {
            // Check start date
            if ($item->start_date == $nd) $item->start_date = $item->created;

            // Check end date
            if ($item->end_date == $nd) $item->end_date = self::getEndDate($item->id);
